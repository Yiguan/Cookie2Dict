...
setup(
  name = 'Cookie2Dict',         # How you named your package folder (MyLib)
  ...
  author_email = 'wang.yiguan@163.com',      # Type in your E-Mail
  url = 'https://github.com/Yiguan/Cookie2Dict',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Yiguan/Cookie2Dict/Cookie2Dict-master.zip',    # I explain this later on
